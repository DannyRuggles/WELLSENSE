...
Model #1 - Abrupt Increase of BSW (sedament water)

This is an offline version of the model that runs locally, and includes all the required files.

Step 1 : Run the 'dependencies' batch file to install the needed libraries and proper versions.
